from engine.utils import letter_to_color #IGNORE:E0611
from engine.utils import SNAKE_VALUES
import os
...
class Snake:
    ...
    def draw(self):
        ...
        for i in xrange(len(self.elements)):
            ...
            if next:
                pygame.draw.line(self.surface,clr, se.get_center(), next._get_center(),15)
            se.draw()
